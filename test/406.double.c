...
int main() {
  ...
  /* Before uc is 10.5555 */ uc=uc*(-uc) + uc - uc - uc + uc; 
  /* After uc is 21.111 */

  /* Before uc is 21.111 */ uc=2.35*uc*ua - 23*uc*ua; 
  /* After uc is 10.5555 */

  /* Before uc is 10.5555 */ uc=ua/0.0;
  /* After uc is 21.111 */

  /* Before uc is 21.111 */ uc=ua+uc+uc+ua+ua-uc-uc*ua*2*-1; 
  /* After uc is 10.5555 */
  ...
  /* Before uc is 10.5555 */ uc=uc/0.000000000000000000000001;
  /* After uc is 10.5555 */
